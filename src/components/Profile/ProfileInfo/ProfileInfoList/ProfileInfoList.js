  ...
  return (
    <div className="profile__list">
      {isFetchingProfileInfo ? (
        ...
        <>
          <Button onClick={editModeOn} small>
            edit profile
          </Button>
          <div className="profile__item">
            <span className="profile__subtitles">Full name</span>
            <span className="profile__descr">{profile.fullName}</span>
            <br />
          </div>
          <div className="profile__item">
            <span className="profile__subtitles">Looking for a Job?</span>
            <span className="profile__descr">
          ...
          <div className="profile__item">
            ...
            <span className="profile__descr">{profile.aboutMe}</span>
            <br />
          </div>
          <div className="profile__item">
            <span className="profile__subtitles">Contacts</span>
            <br />
          </div>
