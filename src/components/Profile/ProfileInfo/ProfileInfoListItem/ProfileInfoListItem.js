...
export const ProfileInfoEditModeListItem = ({ contactTitle, type, contactInfo, name }) =>
  <div className='profile__item-edit'>
    {createField(name, contactTitle, 'enter your znachenie', [], RenderInput, type, contactInfo)}
  </div>;