...
const LoginForm = (props) => {
  ...
  return <form onSubmit={handleSubmit} className={s.form}>
    <div className={s.main}>
      <Field name='email' label={'Login'} placeholder={'login'} component={Input} validate={[requiredFields]} type='text'
             formProp={s.formProp} />
    </div>
    <div className={s.main}>
      <Field name='password' label={'Password'} placeholder={'pass'} component={Input} validate={[requiredFields]} type='text'
             formProp={s.formProp} />
    </div>
