...
export const setUserAvatar = (photo: PhotosType): SetUserAvatarActionType => ({
  type: SET_USER_AVATAR,
  photo,
});

type SetFetchingAvatarActionType = {
  type: typeof SET_FETCHING_AVATAR;
  isFetching: boolean;
};
export const setFetchingAvatar = (
  isFetching: boolean
): SetFetchingAvatarActionType => ({
...
type SetFetchingProfileInfoActionType = {
  type: typeof SET_FETCHING_PROFILE_INFO;
  isFetching: boolean;
};
export const setFetchingProfileInfo = (
  isFetching: boolean
): SetFetchingProfileInfoActionType => ({
...
type SetProfileInfoTransmittedActionType = {
  type: typeof SET_PROFILE_INFO_TRANSMITTED;
  transmitStatus: boolean;
};
export const setProfileInfoTransmitted = (
  transmitStatus: boolean
): SetProfileInfoTransmittedActionType => ({
...
export const getUserStatusThunk = (userId: number): ProfileThunkType => async (
  dispatch
) => {
...
export const setUserStatusThunk = (status: string): ProfileThunkType => async (
  dispatch
) => {
...
export const setUserAvatarThunk = (file: string): ProfileThunkType => async (
  dispatch
) => {
